...
public class MenuNavigationView extends BottomNavigationView {
  ...
  private void init(AttributeSet attrs, int defStyleAttr) {
    ...
    for (int i = 0; i < j; i++) {
      getLargeLabelAt(i).setPadding(0, 0, 0, (int) getResources().getDimension(R.dimen.margin_small));
      getSmallLabelAt(i).setPadding(0, 0, 0, (int) getResources().getDimension(R.dimen.margin_small));
    }
  }
...
//            System.out.println("mLargeLabel.getMeasuredHeight():" + getFontHeight(mSmallLabelSize));
  ...
  private static class MyOnNavigationItemSelectedListener implements OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
      ...
      if ((position == 0 && previousPosition == 2) || (position == 2 && previousPosition == 0)
          || ((position == 2 && previousPosition == -1))) {
        viewPager.setCurrentItem(items.get(item.getItemId()), false);
      } else {
